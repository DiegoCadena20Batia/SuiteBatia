...
public partial class SupervisionMantenimientoHidrantesObjectPage : MasterPage
{
	public SupervisionMantenimientoHidrantesObjectPage(SupervisionMantenimientoHidrantesObjectViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
    ...
    private void ScrollPreguntasToTop() {
        MainThread.BeginInvokeOnMainThread(() => {
            if(PreguntasHidranteCollection.ItemsSource != null) {
                PreguntasHidranteCollection.ScrollTo(
                    0,
