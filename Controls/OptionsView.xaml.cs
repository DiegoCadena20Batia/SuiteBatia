...
public partial class OptionsView : ContentView {
    ...
    public static readonly BindableProperty TextProperty =
        BindableProperty.Create(nameof(Text), typeof(string), typeof(OptionsView), null);

    public static readonly BindableProperty ValorProperty =
        BindableProperty.Create(nameof(Valor), typeof(object), typeof(OptionsView), null, BindingMode.TwoWay,
            propertyChanged: (bindable, oldValue, newValue) => {
                OptionsView currentControl = (OptionsView)bindable;
    ...
    public static readonly BindableProperty IsFloatValueProperty =
        BindableProperty.Create(nameof(IsFloatValue), typeof(bool), typeof(OptionsView), false, BindingMode.TwoWay);
